...
export const canvasOpSchema = z.discriminatedUnion("type", [
    ...
    z.object({ type: z.literal("connect_nodes"), id: z.string().optional(), fromNodeId: z.string(), toNodeId: z.string(), sourcePort: z.string().optional(), targetPort: z.string().optional() }).passthrough(),
...
export const toolInputSchemas = {
    ...
    canvas_connect_nodes: z.object({ connections: z.array(z.object({ fromNodeId: z.string(), toNodeId: z.string(), sourcePort: z.string().optional(), targetPort: z.string().optional() })).min(1) }),
...
export const toolDescriptions: Record<ToolName, string> = {
    ...
    canvas_connect_nodes: "批量连接节点。可指定 sourcePort/targetPort，默认使用 output/input；自环、成环、重复端口边和不支持的节点类型会被画布拒绝。",

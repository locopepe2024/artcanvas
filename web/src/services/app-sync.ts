...
import { coreStore, type BrowserKeyValueStore } from "@/services/browser-kv-storage";
...
const videoLogStore = coreStore("video_generation_logs");
type LogStore = BrowserKeyValueStore;
